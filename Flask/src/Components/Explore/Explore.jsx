...
const Explore = () => {
  ...
  <div>
    ...
    <div className="cards">
        ...
        <div className="card"><Link to={'/ai'}><img id='ai' src="ai.png" alt="" /><div className='card-content'><h2>ARTIFICIAL INTELLIGENCE</h2><p>Unlock endless creative possibilities with Gemeni, the ultimate content generation AI. Create compelling text effortlessly</p><Button name='CONTENT AI'/></div></Link></div>
